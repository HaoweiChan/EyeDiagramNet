...
DDR_PARAMS = ParameterSet(
    ...
    C_tx=LinearParameter(low=0.1, high=0.1, scaler=1e-12),
    C_rx=LinearParameter(low=0.1, high=0.1, scaler=1e-12),
    L_tx=LinearParameter(low=0.0, high=0.2, scaler=1e-9),
    L_rx=LinearParameter(low=0.0, high=0.2, scaler=1e-9),
